   ...
   public function getMiniAppTransactionList(Request $req)
{
    ...
    foreach ($transactions as $transaction) {
        ...
        if ($miniApp) {
            $miniApp->icon   = $miniApp->icon   ? asset('public/upload/images/' . $miniApp->icon)   : '';
            $miniApp->logo   = $miniApp->logo   ? asset('public/upload/images/' . $miniApp->logo)   : '';
            $miniApp->banner = $miniApp->banner ? asset('public/upload/images/' . $miniApp->banner) : '';
