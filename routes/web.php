...
// ✅ Protected admin route (after login)
Route::middleware('admin.token')->group(function () {
    Route::get('/admin', [AdminHomePageController::class, 'HomePage'])->name('admin.dashboard');
});
...
Route::get('adminnotificationlist', [NotificationsController::class, 'adminnotificationlist'])->name('admin.notification.list');
Route::get('CreateNotificationAndUpdate/{id?}', [NotificationsController::class, 'CreateNotificationAndUpdate'])->name('admin.notification.create');
Route::post('createandupdatenotificationprocess', [NotificationsController::class, 'createandupdatenotificationprocess'])->name('admin.notification.create.process');
Route::get('deleteNotificationProcess/{id}', [NotificationsController::class, 'deleteNotificationProcess'])->name('admin.notification.delete');
Route::get('sendAdminNotifications/{id}', [NotificationsController::class, 'sendAdminNotifications'])->name('admin.notification.send');
