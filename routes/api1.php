...
Route::middleware(['user_auth'])->group(function(){
    Route::GET('/withdrawals/transactions',[WithdrawalController::class, 'getWithdrawalTxnList']);
...
Route::middleware(['user_auth'])->group(function(){
Route::post('/miniapp/transactions',[MiniAppTxnController::class, 'getMiniAppTransactionList']);
});
