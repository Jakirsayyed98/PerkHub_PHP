            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <form action="ProcessAddOrUpdate" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="name" class="form-control" value="{{$records->terms ?? ''}}"
                                        name="terms" placeholder="Enter terms">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" style="width: 100%;" name="miniAppID">
                                        ...
                                        @if(isset($records->miniAppID))
                                        @if($records->miniAppID=='0')
                                        <option value="0" selected="selected">Please select miniapp</option>

                                         @else

                                        @foreach($miniAppList as $item)
                                        @if($item->id == $records->miniAppID)
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" style="width: 100%;" name="type">
                                        ...
                                        @if($records)
                                        @if($records->type=="0")
                                        <option value="0" selected="selected">Offer</option>
                                        <option value="1">Coupon</option>

                                        @elseif($records->coupon_status=="1")
                                        <option value="0">Offer</option>
                                        <option value="1" selected="selected">Coupon</option>

                                        @else
                                        <option value="2" selected="selected">Please select Offer type
                                        </option>
                                        <option value="0">Offer</option>
                                        <option value="1">Coupon</option>
                                        @endif
