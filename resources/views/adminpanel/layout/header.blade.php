...
<head>
    ...
    <link rel="stylesheet"
        href="{{url('adminpanel/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css')}}">
    <!-- iCheck -->
    ...
    <img class="animation__shake" src="{{url('adminpanel/dist/img/AdminLTELogo.png')}}" alt="AdminLTELogo" height="60" width="60">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="{{url('adminpanel/dist/img/user1-128x128.jpg')}}" alt="User Avatar"
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="{{url('adminpanel/dist/img/user8-128x128.jpg')}}" alt="User Avatar"
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="{{url('adminpanel/dist/img/user3-128x128.jpg')}}" alt="User Avatar"
                                    class="img-size-50 img-circle mr-3">
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                        Nora Silvester
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="admin" class="brand-link">
                ...
                <span class="brand-text font-weight-light">PerkHub</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{url('adminpanel/dist/img/user2-160x160.jpg')}}" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
                        <a href="admin" class="d-block">Jakir Sayyed</a>
                    </div>
                </div>
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <a href="WithdrawalList?status=0" class="nav-link"  name="status" value="0">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Withdrawal Pending</p>
                                    </a>
                                   

                                    <a href="WithdrawalList?status=1" class="nav-link"  name="status" value="1">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Withdrawal Completed</p>
                                    </a>

                                    <a href="WithdrawalList?status=2" class="nav-link"  name="status" value="2">
                                        <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="adminnotificationlist" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
